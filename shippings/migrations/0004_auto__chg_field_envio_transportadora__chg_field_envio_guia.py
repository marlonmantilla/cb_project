...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Envio.transportadora'
        db.alter_column('shippings_envio', 'transportadora_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shippings.Transportadora'], null=True))

        # Changing field 'Envio.guia'
        db.alter_column('shippings_envio', 'guia', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Envio.transportadora'
        db.alter_column('shippings_envio', 'transportadora_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['shippings.Transportadora']))

        # Changing field 'Envio.guia'
        db.alter_column('shippings_envio', 'guia', self.gf('django.db.models.fields.CharField')(default='ninguna', max_length=255))
    ...
    models = {
        ...
        'shippings.envio': {
            ...
            'guia': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'transportadora': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['shippings.Transportadora']", 'null': 'True', 'blank': 'True'}),
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.Profile']", 'null': 'True', 'blank': 'True'})
        },
