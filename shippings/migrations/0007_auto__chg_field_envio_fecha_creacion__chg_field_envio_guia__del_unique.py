...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Envio.fecha_creacion'
        db.alter_column('shippings_envio', 'fecha_creacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'Envio.guia'
        db.alter_column('shippings_envio', 'guia', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Envio.fecha_creacion'
        db.alter_column('shippings_envio', 'fecha_creacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 1, 22)))

        # Changing field 'Envio.guia'
        db.alter_column('shippings_envio', 'guia', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
    ...
    models = {
        ...
        'shippings.envio': {
            ...
            'guia': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'transportadora': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shippings.Transportadora']", 'null': 'True', 'blank': 'True'}),
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.Profile']", 'null': 'True', 'blank': 'True'})
        },
