...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Envio.comprado'
        db.add_column('shippings_envio', 'comprado', self.gf('django.db.models.fields.CharField')(default='Por usuario', max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Envio.comprado'
        db.delete_column('shippings_envio', 'comprado')
