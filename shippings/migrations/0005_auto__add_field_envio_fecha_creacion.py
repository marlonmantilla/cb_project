...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Envio.fecha_creacion'
        db.add_column('shippings_envio', 'fecha_creacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 1, 21), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Envio.fecha_creacion'
        db.delete_column('shippings_envio', 'fecha_creacion')
