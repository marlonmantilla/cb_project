...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Transportadora'
        db.create_table('shippings_transportadora', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('shippings', ['Transportadora'])

        # Adding model 'Envio'
        db.create_table('shippings_envio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('proveedor', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('guia', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('transportadora', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shippings.Transportadora'])),
            ...
            ('oferta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Oferta'], null=True, blank=True)),
        ))
        db.send_create_signal('shippings', ['Envio'])

        # Adding M2M table for field productos on 'Envio'
        db.create_table('shippings_envio_productos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('envio', models.ForeignKey(orm['shippings.envio'], null=False)),
            ('producto', models.ForeignKey(orm['offers.producto'], null=False))
        ))
        db.create_unique('shippings_envio_productos', ['envio_id', 'producto_id'])


    def backwards(self, orm):
        
        # Deleting model 'Transportadora'
        db.delete_table('shippings_transportadora')

        # Deleting model 'Envio'
        db.delete_table('shippings_envio')

        # Removing M2M table for field productos on 'Envio'
        db.delete_table('shippings_envio_productos')
    ...
    models = {
        ...
        'shippings.envio': {
            ...
            'guia': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
