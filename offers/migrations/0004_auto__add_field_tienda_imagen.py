...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tienda.imagen'
        db.add_column('offers_tienda', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tienda.imagen'
        db.delete_column('offers_tienda', 'imagen')
