...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('offers_producto', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Producto.usuario'
        db.delete_column('offers_producto', 'usuario_id')
