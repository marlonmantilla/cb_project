...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Oferta.fecha_creacion'
        db.add_column('offers_oferta', 'fecha_creacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 1, 6), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Oferta.fecha_creacion'
        db.delete_column('offers_oferta', 'fecha_creacion')
