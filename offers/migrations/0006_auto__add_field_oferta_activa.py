...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Oferta.activa'
        db.add_column('offers_oferta', 'activa', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Oferta.activa'
        db.delete_column('offers_oferta', 'activa')
